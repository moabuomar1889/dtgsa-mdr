...
export default async function IdentityAdministrationPage() {
  ...
  return (
    <RegisterWorkspace
      ...
      description="Review account-link exceptions first, then manage directory synchronization, role mappings, and external access."
      metrics={[
        { label: "Mappings", value: overview.mappings.length },
        { label: "Invitations", value: overview.invitations.length },
        { label: "Sync runs", value: overview.syncRuns.length },
        { label: "Link reviews", value: overview.linkReviews.length },
      ]}
    >
      ...
      <details className="order-2">
        <summary className="border-line bg-panel hover:bg-raise cursor-pointer rounded-[10px] border px-4 py-3 text-sm font-semibold">
          Group mappings and external invitations
        </summary>
        <section className="mt-3 grid gap-4 xl:grid-cols-2">
          <Card className="order-1">
            ...
            <CardContent className="space-y-5">
              <form
                action={saveGoogleGroupMappingAction}
